-- Sprint 54: expose vendor wallet balance in directory RPC for mobile cards.
...
COMMENT ON FUNCTION public.get_contact_directory(UUID, INTEGER, INTEGER, UUID, UUID) IS
  'Paginated vendor directory scoped to a business workspace (NULL business_id = personal ledgers). Includes wallet_balance for mobile cards.';
